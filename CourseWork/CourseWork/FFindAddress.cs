...
namespace CourseWork
{
   public partial class FFindAddress : Form
   {
      ...
      private void bFind_Click(object sender, EventArgs e)
      {
         ...
         address = tbNumber.Text;
         FMain.Output(BoxOutput, FMain.user, amount, "Address", address);

         if (arrAmount[0] < 0)
         {
            label1.Text = "Знакомого с таким адресом не существует!";
         }

         else
         {
            label1.Text = "Введите адрес вашего знакомого";
