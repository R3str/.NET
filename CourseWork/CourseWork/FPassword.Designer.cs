namespace CourseWork
{
   partial class FPassword
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.label1.Text = "Для того, что бы пользоваться программой, сначала введите пароль";
         // 
         // textBox1
         // 
         ...
         this.Name = "FPassword";
         this.Text = "FPassword";
         this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FPassword_FormClosed);
