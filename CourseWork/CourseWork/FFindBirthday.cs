...
{
   public partial class FFindBirthday : Form
   {
      ...
      private void FFindBirthday_Load(object sender, EventArgs e)
      {
      ...
      private void bFind_Click(object sender, EventArgs e)
      {
         ...
         DateOfBirthday = tbNumber.Text;
         FMain.Output(BoxOutput, FMain.user, amount, "Birthday", DateOfBirthday);

         if (arrAmount[0] < 0)
         {
            label1.Text = "Знакомого с такой датой рождения не существует!";
         }

         else
         {
            label1.Text = "Введите дату рождения вашего знакомого";
            ...
            for (int i = 0; i < FMain.amount; i++)
            {
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     DateOfBirthday = FMain.user[amount].Bithday.ToString("yyyy.MM.dd");
                     FMain.Output(BoxOutput, FMain.user, amount, "Birthday", DateOfBirthday);
                     break;
                  }
               }
