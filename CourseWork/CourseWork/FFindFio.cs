...
{
   public partial class FFindFio : Form
   {
      ...
      private void FFindFio_Load(object sender, EventArgs e)
      {
      ...
      private void bFind_Click(object sender, EventArgs e)
      {
         ...
         fio = tbNumber.Text;
         FMain.Output(BoxOutput, FMain.user, amount, "Fio", fio);

         if(arrAmount[0] < 0)
         {
            label1.Text = "Знакомого с такими инициалами не существует!";
         }

         else
         {
            label1.Text = "Введите ФИО вашего знакомого";
            ...
            for (int i = 0; i < FMain.amount; i++)
            {
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     FMain.Output(BoxOutput, FMain.user, amount, "Fio", FMain.user[amount].Fio);
                     break;
                  }
               }
            }
