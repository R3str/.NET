...
namespace _5
{
   ...
   class Program
   {
      ...
      static void Main(string[] args)
      {
         ...
         Groods groods = new Groods("Газировка 'Pepsi'", 18, "11.01.2020", "1&34b48X");
         MilkProduct milk = new MilkProduct("Кумыс", 49.95, "24.11.2019", "008&3X0Z", "+6");
         Console.WriteLine("Что желаете просмотреть?" + "\n\t1 - Игрушка" + "\n\t2 - Продукт" + "\n\t3 - Товар" + "\n\t4 - Молочный продукт");
         MyDelegate output;
